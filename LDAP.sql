...
INSERT INTO `identities` (`identity_id`, `name`, `created_at`) VALUES
	(NULL, 'PRESIDENT', CURRENT_DATE()), (NULL, 'VICE_PRESIDENT', CURRENT_DATE()),
	(NULL, 'MANAGER', CURRENT_DATE()), (NULL, 'DEVELOPER', CURRENT_DATE());

INSERT INTO `parties` (`party_id`, `full_name`, `email`, `created_at`, `updated_at`) VALUES
	(NULL, 'Joe Shmoe', 'joe.shmoe@example.com', CURRENT_DATE(), CURRENT_DATE());
