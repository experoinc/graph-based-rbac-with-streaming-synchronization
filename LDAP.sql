...
INSERT INTO `parties` (`id`, `name`, `party_type`, `created_at`, `updated_at`) VALUES
	(1, 'Boss', 'Organizer', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(2, 'Underboss', 'Organizer', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(3, 'Consiglieri', 'Organizer', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(4, 'Caporegime', 'Organizer', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(5, 'Button', 'Soldier', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
INSERT INTO `profiles` (`id`, `name`, `created_at`, `updated_at`) VALUES
	...
	(45, 'Work', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
INSERT INTO `accesses` (`person_id`, `resource_id`, `successful`, `created_at`) VALUES
	(10, 35, TRUE, CURRENT_TIMESTAMP()),
	(12, 30, TRUE, CURRENT_TIMESTAMP()),
	(13, 30, TRUE, CURRENT_TIMESTAMP()),
	(14, 30, TRUE, CURRENT_TIMESTAMP()),
	(15, 30, TRUE, CURRENT_TIMESTAMP()),
	(21, 33, TRUE, CURRENT_TIMESTAMP()),
	(21, 36, TRUE, CURRENT_TIMESTAMP()),
	(21, 34, FALSE, CURRENT_TIMESTAMP()),
	(21, 31, TRUE, CURRENT_TIMESTAMP()),
	(11, 35, FALSE, CURRENT_TIMESTAMP()),
	(11, 33, TRUE, CURRENT_TIMESTAMP()),
	(11, 32, TRUE, CURRENT_TIMESTAMP()),
	(11, 34, TRUE, CURRENT_TIMESTAMP()),
	(18, 30, TRUE, CURRENT_TIMESTAMP()),
	(19, 30, TRUE, CURRENT_TIMESTAMP()),
	(20, 30, TRUE, CURRENT_TIMESTAMP()),
	(21, 30, TRUE, CURRENT_TIMESTAMP()),
	(22, 30, TRUE, CURRENT_TIMESTAMP()),
	(18, 31, TRUE, CURRENT_TIMESTAMP()),
	(19, 31, TRUE, CURRENT_TIMESTAMP()),
	(20, 31, TRUE, CURRENT_TIMESTAMP()),
	(21, 31, TRUE, CURRENT_TIMESTAMP()),
	(22, 31, FALSE, CURRENT_TIMESTAMP()),
	(22, 32, FALSE, CURRENT_TIMESTAMP()),
	(17, 32, TRUE, CURRENT_TIMESTAMP());
...
INSERT INTO `identified_by` (`party_id`, `person_id`, `created_at`, `updated_at`) VALUES
	...
	(5, 22, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
INSERT INTO `manages_people` (`party_id`, `person_id`, `created_at`, `updated_at`) VALUES
	(1, 10, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	...
	(5, 21, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(5, 22, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO `manages_profiles` (`party_id`, `profile_id`, `created_at`, `updated_at`) VALUES
	(1, 40, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(1, 41, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(2, 41, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(2, 43, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(2, 44, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(3, 41, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	...
	(4, 44, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(4, 45, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO `owns` (`party_id`, `resource_id`, `created_at`, `updated_at`) VALUES
	...
	(2, 33, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(5, 30, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(5, 31, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP()),
	(5, 32, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
